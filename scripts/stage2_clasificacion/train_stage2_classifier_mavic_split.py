"""
train_stage2_classifier_mavic_split.py
=============================

Entrena un clasificador multiclase Stage 2 sobre el CSV:

    spectrograms_stage2_mavic_split.csv
...
La idea es equivalente a train_detector.py, pero adaptada a 6 clases:
...
Uso tipico desde la raiz del proyecto:
    ...
    uv run python scripts/train_stage2_classifier_mavic_split.py ^
        --csv data/stage2_classifier_v1/metadata/spectrograms_stage2_mavic_split.csv ^
        --data-root . ^
        --epochs 30 ^
        --batch-size 32 ^
        --freeze-backbone 3
...
CLASS_NAMES = ["f450", "hunter", "mavic_video", "mavic_novideo", "mini3", "interference"]
...
DEFAULT_CSV = Path("data/stage2_classifier_v1/metadata/spectrograms_stage2_mavic_split.csv")
DEFAULT_ARTIFACTS = Path("data/stage2_classifier_v2_mavic_split/artifacts/resnet18_stage2_mavic_split")
