...
\vspace*{2cm}
\noindent D. \textbf{\tfgtutorA}, Profesor del Departamento de Ingenieria de Computadores, Automatica y Robotica de la Universidad de Granada.

\ifx\tfgtutorB\empty\else
  \vspace{0.4cm}
  \noindent D. \textbf{\tfgtutorB}, Profesor del Departamento de Ingenieria de Computadores, Automatica y Robotica de la Universidad de Granada.
\fi
