...
\newcommand{\tfgtutorB}{}% Vacio si solo hay un tutor
...
\include{preliminares/resumen_es}
\include{preliminares/resumen_en}
\include{preliminares/autorizacion}
\include{preliminares/informe_tutores}
...
\include{capitulos/03_requisitos_y_diseno}
\include{capitulos/04_implementacion}
\include{capitulos/05_pruebas_y_resultados}
